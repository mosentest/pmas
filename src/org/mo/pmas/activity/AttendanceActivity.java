...
public class AttendanceActivity extends BaseFramgmentActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ("学生".equals(preferences.getString(UserDetail.ColumnName.ROLE_NAME, null))) {
            layout_AttendRecord.setVisibility(View.GONE);
            layout_AttendCount.setVisibility(View.GONE);
            layout_AttendForm.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.layout_AttendRecord:
                ...
                departId = preferences.getString(UserDetail.ColumnName.DEPART_ID, null);
                departname = preferences.getString(UserDetail.ColumnName.DEPART_NAME, null);
                rolename = preferences.getString(UserDetail.ColumnName.ROLE_NAME, null);
            ...
            case R.id.layout_StudentAttendance:
                ...
                //把学生的id传过去
                studentId = preferences.getString(UserDetail.ColumnName.ID, null);
                rolename = preferences.getString(UserDetail.ColumnName.ROLE_NAME, null);
